...
if(isset($this->session->userdata['logged_in']))
{
    ...
    $avata = ($this->session->userdata['logged_in']['avata']);
...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design"/>
    ...
    <!-- Bootstrap Core CSS -->
    <link href="<?php echo base_url(); ?>asset/testgiaodien/css/bootstrap.min.css" rel='stylesheet' type='text/css'/>
    <!-- Custom CSS -->
    <link href="<?php echo base_url(); ?>asset/testgiaodien/css/style.css" rel='stylesheet' type='text/css'/>
    <!-- Graph CSS -->
    <link href="<?php echo base_url(); ?>asset/testgiaodien/css/font-awesome.css" rel="stylesheet">
    <!-- jQuery -->
    <link href='//fonts.googleapis.com/css?family=Roboto:700,500,300,100italic,100,400' rel='stylesheet'
          type='text/css'>
    <!-- lined-icons -->
    <link rel="stylesheet" href="<?php echo base_url(); ?>asset/testgiaodien/css/icon-font.min.css" type='text/css'/>
    <!-- /js -->
    <script src="<?php echo base_url(); ?>asset/testgiaodien/js/jquery-1.10.2.min.js"></script>
    <!-- //js-->
</head>
<body>
<div class="page-container">
        ...
        <div class="inner-content">
            ...
            <div class="header-section">
                ...
                <div class="top_menu">
                    <div class="main-search">
                        ...
                        <div class="close"><img src="<?php echo base_url(); ?>asset/testgiaodien/images/cross.png"/>
                        </div>
                    </div>
                    <div class="srch">
                        <button></button>
                                ...
                                <ul class="dropdown-menu two">
                                    ...
                                    <li><a href="#">
                                            <div class="user_img"><img
                                                        src="<?php echo base_url(); ?>asset/testgiaodien/images/in.jpg"
                                                        alt=""></div>
                                    ...
                                    <li class="odd"><a href="#">
                                            <div class="user_img"><img
                                                        src="<?php echo base_url(); ?>asset/testgiaodien/images/in5.jpg"
                                                        alt=""></div>
                                            <div class="notification_desc">
                                                <p>Lorem ipsum dolor sit amet </p>
                                                <p><span>1 hour ago</span></p>
                                    ...
                                    <li><a href="#">
                                            <div class="user_img"><img
                                                        src="<?php echo base_url(); ?>asset/testgiaodien/images/in8.jpg"
                                                        alt=""></div>
                                            <div class="notification_desc">
                                                <p>Lorem ipsum dolor sit amet </p>
                                                <p><span>1 hour ago</span></p>
            ...
            <div class="outter-wp">
                ...
                <div class="profile-widget">
                    <img src=<?php echo base_url().$avata; ?> alt=' ' />
                    <?php echo "<h2>$name</h2>"; ?>
                ...
                <div class="profile-section-inner">
                    <div class="col-md-6 profile-info">
                        ...
                        <div class="main-grid3 p-skill">
                            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum
                                ...
                                unchanged.</p>
                            <p class="para">But also the leap into electronic typesetting, remaining essentially
                                unchanged.</p>
                    ...
                    <div class="col-md-6 profile-info two">
                        <h3 class="inner-tittle">Exams History </h3>
                        <div class="main-grid3 p-skill">
                    ...
                    <div class="col-md-6 profile-info two">
                        ...
                        <div class="main-grid3 map">
                            ...
                            <div class="gmap-info">
                                <h4><i class="fa fa-map-marker"></i> <b><a href="#" class="text-dark">Augment Pvt.
                                            Ltd</a></b></h4>
    ...
    <div class="sidebar-menu">
        ...
        <!--/down-->
        <div class="down">
            <a href='index.html'><img src=<?php echo base_url().$avata; ?> /></a>
            <a href="index.html"><span class=" name-caret"><?php echo $name; ?></span></a>
            <p><?php echo $position; ?></p>
            <ul>
                <li><a class="tooltips" href="index.html"><span>Profile</span><i class="lnr lnr-user"></i></a></li>
                <li><a class="tooltips" href="edit"><span>Edit profile</span><i class="lnr lnr-cog"></i></a></li>
...
<!--js -->
<script src="<?php echo base_url(); ?>asset/testgiaodien/js/jquery.nicescroll.js"></script>
<script src="<?php echo base_url(); ?>asset/testgiaodien/js/scripts.js"></script>
<!-- Bootstrap Core JavaScript -->
<script src="<?php echo base_url(); ?>asset/testgiaodien/js/bootstrap.min.js"></script>
</body>
</html>